...
1. Rule: Strict Constraint for pydantic/pydantic - Context: Aggregated from core maintainer feedback to prevent recurring architecture violations.. Enforce: To get this skipped in coverage, could you update the coverage config to be (instead of using `exclude_lines`):
